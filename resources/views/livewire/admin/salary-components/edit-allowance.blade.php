<div>
    ...
    <flux:modal name="edit-allowance-{{ $allowance->id }}" class="md:w-96">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Edit Allowance</flux:heading>
                <flux:text class="mt-2">Make changes to your personal details.</flux:text>
            </div>
            <form wire:submit="updateAllowance" class="space-y-4">
